...
<div class="body">
		...
		<div class="infor">
			<div class="infor_title">天津大学学历代办</div>
			<div class="infor_price"><h4 id="price">统一零售价：9999</h4><br/><h4 id="price1">促销价：9998</h4></div>
			<div class="infor_infor"></div>
			<div class="save"><a href="<%=application.getContextPath()%>/UserServlet?op=save&op1=3">收藏</a></div>
			<div class="delete"><a href="<%=application.getContextPath()%>/UserServlet?op=delete&op1=3">取消收藏</a></div>
		</div>
		</div>
</body>
</html>