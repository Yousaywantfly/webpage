...
<div class="body">
		...
		<div class="infor">
			<div class="infor_title">天津大学仁爱学院学历代办</div>
			<div class="infor_price"><h4 id="price">统一零售价：9999</h4><br/><h4 id="price1">促销价：9.9</h4></div>
			<div class="infor_infor"></div>
			<div class="save"><a href="<%=application.getContextPath()%>/UserServlet?op=save&op1=5">收藏</a></div>
